// Verbatim port of pbrt-v4 src/pbrt/film.cpp:263-479
// PixelSensor::swatchReflectances (24 Macbeth ColorChecker spectra).
//
// Source attribution (from v4): Danny Pascale's Macbeth chart measurements.
...
pub const N_SWATCHES: usize = 24;
pub const N_SWATCH_SAMPLES: usize = 36;

#[rustfmt::skip]
pub const SWATCH_LAMBDA: [Float; N_SWATCH_SAMPLES] = [
...
#[rustfmt::skip]
pub const SWATCH_VALUES: [[Float; N_SWATCH_SAMPLES]; N_SWATCHES] = [
    // Swatch 0 (dark skin)
