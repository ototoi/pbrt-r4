...
fn shade_surface(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    let material_layout = material_tree_layouts[instance.material_tree_layout];
    let material_kind = load_material_kind(material_layout.node_offset);
    ...
    surfaces[pixel_index].material_tree_layout = instance.material_tree_layout;
